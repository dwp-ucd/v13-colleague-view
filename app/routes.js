...
router.post('/prototype-dev-baseline/sprint23/opt1/index', function (req, res) {
  req.session.data['What-type-of-engagement-is-it-sprint23-opt1'] = '';
  req.session.data['Who-is-the-engagement-with-sprint23-opt1'] = '';
  req.session.data['Who-is-the-engagement-with'] = '';
  
  res.redirect('/prototype-dev-baseline/sprint23/opt1/index');
})

router.post('/prototype-dev-baseline/sprint23/opt1/call-type', function (req, res) {
  req.session.data['What-type-of-engagement-is-it-sprint23-opt1'] = '';
  req.session.data['Who-is-the-engagement-with-sprint23-opt1'] = '';
  req.session.data['Who-is-the-engagement-with'] = '';
  req.session.data['Do-you-want-to-complete-the-session'] = '';
...
if (req.session.data['national-insurance-number-sprint23'] == 'QQ123456Q' || req.session.data['national-insurance-number-sprint23'] == 'qq123456q' || req.session.data['national-insurance-number-sprint23'] == 'QQ 12 34 56 Q') {
  // Send user to next page
  res.render('prototype-dev-baseline/sprint23/opt1/call-type');
} else {
  var errMsg = "";
  if (req.session.data['national-insurance-number-sprint23'] == '' || req.session.data['national-insurance-number-sprint23'] == undefined) {
    errMsg = "Enter the customer's National Insurance number";
  ...
  // Send user to error page
  res.render('prototype-dev-baseline/sprint23/opt1/showValidationMsg/error-NINO-number', { "errMsg": errMsg });
}
})

// this is for radio selection
router.post('/prototype-dev-baseline/sprint23/opt1/call-with', function (req, res) {
  ...
  if (req.session.data['What-type-of-engagement-is-it-sprint23-opt1'] == '') {
      // Send user to error page
      // res.redirect('/prototype-dev-baseline/sprint23/opt1/showValidationMsg/error-Call-Type');
      res.redirect('back');
  } else{
    // Send user to next page
    res.redirect('/prototype-dev-baseline/sprint23/opt1/call-with');
  }
  })
...
router.post('/prototype-dev-baseline/sprint23/opt1/returning-user/contact-history', function (req, res) {
  ...
  if (completeSession == "Yes") {
    // Send user to next page
    res.redirect('/prototype-dev-baseline/sprint23/opt1/returning-user/contact-history');
  } else {
    res.redirect('/prototype-dev-baseline/sprint23/opt1/returning-user/confirmation-complete-session-Error');
  }
});

router.post('/prototype-dev-baseline/sprint23/opt1/engagement-log-journey/benefitPages', function (req, res) {
var pageLength = '';
var isEsa = req.session.data['What-services-have-they-called-about'].includes('esa');
var isPip = req.session.data['What-services-have-they-called-about'].includes('pip');
var isCa = req.session.data['What-services-have-they-called-about'].includes('ca');
...
if (isEsa && isPip) {
  res.render('prototype-dev-baseline/sprint23/opt1/engagement-log-journey/what-queries-dealt-with-ESA', {
    "nextUrl": '/prototype-dev-baseline/sprint23/opt1/engagement-log-journey/what-queries-dealt-with-PIP',
    "pageLength": pageLength
  });
}
if (isEsa && isCa && !isPip) {
  // console.log('considition executed isEsa && isCa && !isPip');
  res.render('prototype-dev-baseline/sprint23/opt1/engagement-log-journey/what-queries-dealt-with-ESA', {
    "nextUrl": '/prototype-dev-baseline/sprint23/opt1/engagement-log-journey/what-queries-dealt-with-CA',
    "pageLength": pageLength
  });
}
if (isEsa && !isPip && !isCa) {
  // console.log('considition executed isEsa && !isPip && !isCa');
  res.render('prototype-dev-baseline/sprint23/opt1/engagement-log-journey/what-queries-dealt-with-ESA', {
    "nextUrl": '/prototype-dev-baseline/sprint23/opt1/engagement-log-journey/outcome-queries',
    "pageLength": pageLength
...
if (!isEsa && isPip && isCa) {
  // console.log('considition executed !isEsa && isPip && isCa');
  res.render('prototype-dev-baseline/sprint23/opt1/engagement-log-journey/what-queries-dealt-with-PIP', {
    "nextUrl": '/prototype-dev-baseline/sprint23/opt1/engagement-log-journey/what-queries-dealt-with-CA',
    "pageLength": pageLength
  });
}
...
if (!isEsa && !isPip && isCa) {
  // console.log('considition executed !isEsa && !isPip && isCa');
  res.render('prototype-dev-baseline/sprint23/opt1/engagement-log-journey/what-queries-dealt-with-CA', {
    "nextUrl": '/prototype-dev-baseline/sprint23/opt1/engagement-log-journey/outcome-queries',
    "pageLength": pageLength
  });
}
...
router.post('/prototype-dev-baseline/sprint23/opt1/engagement-log-journey/what-queries-dealt-with-PIP', function (req, res) {
var isPip = req.session.data['What-services-have-they-called-about'].includes('pip');
var isCa = req.session.data['What-services-have-they-called-about'].includes('ca');
var pageLength = '';
if (req.session.data['What-services-have-they-called-about'].length == 1) {
...
router.post('/prototype-dev-baseline/sprint23/opt1/engagement-log-journey/what-queries-dealt-with-CA', function (req, res) {
var pageLength = '';
if (req.session.data['What-services-have-they-called-about'].length == 1) {
  pageLength = 'Services 1 of 1';
} else if (req.session.data['What-services-have-they-called-about'].length == 2) {
...
router.post('/prototype-dev-baseline/sprint23/opt1/engagement-log-journey/outcome-queries', function (req, res) {
...
res.render('prototype-dev-baseline/sprint23/opt1/engagement-log-journey/outcome-queries', {
...
router.get('/prototype-dev-baseline/sprint23/opt1/engagement-log-journey/add-note/:name', function (req, res) {
// console.log(' Add Notes route is called - GET: ',req.params.name);
res.render('prototype-dev-baseline/sprint23/opt1/engagement-log-journey/add-note', {
  "notesName": req.params.name,
  "notesValue": req.session.data[req.params.name]
});
});
...
router.post('/prototype-dev-baseline/sprint23/opt1/engagement-log-journey/confirmation-complete-session', function (req, res) {
  console.log('Value of the session varaible: --------------------------------->',req.session.data['What-services-have-they-called-about']);
  if (req.session.data['What-services-have-they-called-about'].includes('esa')) {
    res.redirect('/prototype-dev-baseline/sprint23/opt1/engagement-log-journey/confirmation-complete-session');
  }else if (req.session.data['What-services-have-they-called-about'].includes('pip')) {
    res.redirect('/prototype-dev-baseline/sprint23/opt1/engagement-log-journey/confirmation-complete-session');
  }if (req.session.data['What-services-have-they-called-about'].includes('ca')) {
    res.redirect('/prototype-dev-baseline/sprint23/opt1/engagement-log-journey/confirmation-complete-session');
  }else {
    res.redirect('/prototype-dev-baseline/sprint23/opt1/engagement-log-journey/no-contactAdded');
  }
  });

  // this is for radio selection for Session complete
router.post('/prototype-dev-baseline/sprint23/opt1/engagement-log-journey/session-completed', function (req, res) {
  var completeSession = req.session.data['Do-you-want-to-complete-the-session'];
  // Check whether the variable matches a condition
  if (completeSession == "Yes") {
    // Send user to next page
    res.redirect('/prototype-dev-baseline/sprint23/opt1/contact-history-callSummeryAddedd#add-to-contact-history');
  } else {
    res.redirect('/prototype-dev-baseline/sprint23/opt1/engagement-log-journey/session-completed');
  }
...
router.post('/prototype-dev-baseline/sprint23/opt1/call-log-journey/questionAnswered', function(req, res) {

  if (req.session.data['questionAsk_esa'] == '' || req.session.data['questionAsk_esa'] == undefined) {
        res.redirect("/prototype-dev-baseline/sprint23/opt1/call-log-journey/selectQuestion-Error")
    } else {
      var isNpd = 'govuk-!-display-none';
      var isNpa = 'govuk-!-display-none';
      var isMp = 'govuk-!-display-none';
      ...
      if(req.session.data['questionAsk_esa'].includes('Reason for a change in payment')) {
        ...
        res.redirect("/prototype-dev-baseline/sprint23/opt1/call-log-journey/questionAnswered")
    }
})
...
router.post('/prototype-dev-baseline/sprint23/opt1/engagement-log-journey/add-note', function (req, res) {
  ...
  if (addMore == "Yes")  {
    // Send user to next page
    res.redirect('/prototype-dev-baseline/sprint23/opt1/engagement-log-journey/add-note');
  } else {
    res.redirect('/prototype-dev-baseline/sprint23/opt1/engagement-log-journey/call-details-added-withoutNote');
  }
  });
...
router.post('/prototype-dev-baseline/sprint23/opt1/engagement-log-journey/session-completed', function (req, res) {
    ...
    if (completeSession2 == "Yes") {
      // Send user to next page
      res.redirect('/prototype-dev-baseline/sprint23/opt1/engagement-log-journey/what-service-called-about');
    } else {
      res.redirect('/prototype-dev-baseline/sprint23/opt1/engagement-log-journey/session-completed');
    }
...
router.post('/prototype-dev-baseline/sprint23/opt1/contact-history-ui',function(req,res){
      res.render("/prototype-dev-baseline/sprint23/opt1/contact-history")
  })

router.post('/prototype-dev-baseline/sprint23/opt1/call-log-journey/selectBenefit', function(req, res) {
  req.session.data['whichBenefitDiscussed'] = '';
  req.session.data['questionAsk'] = '';
  req.session.data['npd_wasQuestionResolved'] = '';
  req.session.data['npa_wasQuestionResolved'] = '';
  ...
  if(req.session.data.outcomePage === ''){
    res.redirect('/prototype-dev-baseline/sprint23/opt1/call-log-journey/selectBenefit');
  } else {
    res.redirect('/prototype-dev-baseline/sprint23/opt1/call-log-journey/selectBenefit');
  }
...
router.post('/prototype-dev-baseline/sprint23/opt1/call-log-journey/selectQuestion', function(req, res) {
  ...
  if (req.session.data['whichBenefitDiscussed'] == '') {
    // errMsg_Benefit = "Select which benefit did you discuss with the caller";
    // res.render('/prototype-dev-baseline/sprint23/opt1/call-log-journey/unHappy_journey/showValidation/selectBenefit-Error', { "errMsg_Benefit": errMsg_Benefit });
    res.redirect("/prototype-dev-baseline/sprint23/opt1/call-log-journey/unHappy_journey/showValidation/selectBenefit-Error")
    ...
    req.session.data.outcomePage = outcomePageData;
    res.redirect("/prototype-dev-baseline/sprint23/opt1/call-log-journey/unHappy_journey/noBenefit/add-Note")
  } else {
  res.redirect("/prototype-dev-baseline/sprint23/opt1/call-log-journey/selectQuestion")
  } 
})

router.post('/prototype-dev-baseline/sprint23/opt1/call-log-journey/wasQuestionResolved', function(req, res) {
    ...
    if (req.session.data['questionAsk'].includes('Something else')) {
      res.redirect("/prototype-dev-baseline/sprint23/opt1/call-log-journey/unHappy_journey/noQuestion/askedClQ")
    } else {
      if(req.session.data['questionAsk'].includes('Next payment date')) {
        isNpd = 'govuk-!-display-block';
      }
    ...
    //All variable render here
    res.render('prototype-dev-baseline/sprint23/opt1/call-log-journey/questionAnswered', {
    "isNpd": isNpd,
    "isNpa": isNpa,
    "isMp": isMp,
    "isRfch": isRfch,
...
router.post('/prototype-dev-baseline/sprint23/opt1/call-log-journey/checkAnswer', function(req, res) {
    ...
    if ((req.session.data['npd_wasQuestionResolved'].includes('Not resolved') || req.session.data['npd_wasQuestionResolved'].includes('Resolved')) || (req.session.data['npa_wasQuestionResolved'].includes('Not resolved') || req.session.data['npa_wasQuestionResolved'].includes('Resolved')) || (req.session.data['ma_wasQuestionResolved'].includes('Not resolved') || req.session.data['ma_wasQuestionResolved'].includes('Resolved')) || (req.session.data['chpa_wasQuestionResolved'].includes('Not resolved') || req.session.data['chpa_wasQuestionResolved'].includes('Resolved'))) {
      //All variable render here
        res.render('prototype-dev-baseline/sprint23/opt1/call-log-journey/checkAnswer', {
          "isNpd": isNpd,
          "isNpa": isNpa,
          "isMp": isMp,
          "isRfch": isRfch,
      ...
      //All variable render here
      res.render('prototype-dev-baseline/sprint23/opt1/call-log-journey/unHappy_journey/showValidation/questionAnswered-Error', {
        "isNpd": isNpd,
        "isNpa": isNpa,
        "isMp": isMp,
        "isRfch": isRfch,
...
router.post('/prototype-dev-baseline/sprint23/opt1/call-log-journey/checkAnswer2', function(req, res) {
  var isNpd = 'govuk-!-display-none';
    var isNpa = 'govuk-!-display-none';
    var isMp = 'govuk-!-display-none';
    var isRfch = 'govuk-!-display-none';
...
// check answer for something else question type
router.post('/prototype-dev-baseline/sprint23/opt1/call-log-journey/checkAnswerForsomethingElse', function(req, res) {
  ...
  if (req.session.data['smelse_wasQuestionResolved'].includes('Resolved') || req.session.data['smelse_wasQuestionResolved'].includes('Not resolved')) {
    ...
    // console.log('Neha')
    //All variable render here
    res.render('prototype-dev-baseline/sprint23/opt1/call-log-journey/unHappy_journey/showValidation/somethingElse-Error', {
      "isNpd": isNpd,
      "isNpa": isNpa,
      "isMp": isMp,
      "isRfch": isRfch,
...
router.post('/prototype-dev-baseline/sprint23/opt1/call-log-journey/check-for-add-Note', function(req, res) {
  //All variable render here
  let outcomePageData = [];
  outcomePageData = req.session.data.outcomePage ? req.session.data.outcomePage : [];
  req.session.data['questionAsk'].map((item)=>{
  ...
  req.session.data.outcomePage =outcomePageData;
 if (req.session.data['discussAnthingElse'] == 'Yes' ) {
   res.redirect("/prototype-dev-baseline/sprint23/opt1/call-log-journey/add-Note")
 } else {
   res.render('prototype-dev-baseline/sprint23/opt1/call-log-journey/summary_CallLogged', {
     "outcomePage":req.session.data.outcomePage,
   });
 }
})
...
// new code bhavin shared at 4:50pm, 5 dec
router.post('/prototype-dev-baseline/sprint23/opt1/call-log-journey/summary_CallLogged', function(req, res) {
  //All variable render here
  if(req.headers.referer == "https://colleague-view.herokuapp.com/prototype-dev-baseline/sprint23/opt1/call-log-journey/add-Note"){
    let outcomePageData=[];
    let outcomePageDataUpdated=[];
    let shortBenefitName="";
    console.log('value of the req.session.data.outcomePage INITIALLY: ',req.session.data.outcomePage);
...
router.get('/prototype-dev-baseline/sprint23/opt1/call-log-journey/add-Note/:id',function(req,res){
  console.log('User is adding new notes: ',req.params.id.trim());
  req.session.data.idname = req.params.id.trim();
  res.redirect('/prototype-dev-baseline/sprint23/opt1/call-log-journey/add-Note');
});
...
// check phone call progress and complete confirmation.
router.post('/prototype-dev-baseline/sprint23/opt1/call-log-journey/confirm_Complete_PhoneCall', function (req, res) {
  if(req.session.data.outcomePage === ''){
    res.redirect('/prototype-dev-baseline/sprint23/opt1/call-log-journey/no-contactAdded');
  } else {
    res.redirect('/prototype-dev-baseline/sprint23/opt1/call-log-journey/confirmation-complete-session');
...
// update note before complete phone call
router.post('/prototype-dev-baseline/sprint23/opt1/call-log-journey/updateNote_beforeCompleteCall', function (req, res) {
  res.redirect("/prototype-dev-baseline/sprint23/opt1/call-log-journey/confirmation-complete-session")
  });

// Complete session
router.post('/prototype-dev-baseline/sprint23/opt1/call-log-journey/phoneCall-completed', function (req, res) {
  var completeSession = req.session.data['Do-you-want-to-complete-the-session-opt2']
  // Check whether the variable matches a condition
  if (completeSession == "Yes") {
    // Send user to next page
    ...
    res.redirect('/prototype-dev-baseline/sprint23/opt1/call-log-journey/session-completed');
  }

});

router.post('/prototype-dev-baseline/sprint23/opt1/addAnotherBenefit', function(req, res) {
  req.session.data['whichBenefitDiscussed'] = '';
  req.session.data['questionAsk'] = '';
  req.session.data['npd_wasQuestionResolved'] = '';
  req.session.data['npa_wasQuestionResolved'] = '';
  ...
  if (req.session.data['addAnotherBenefit'] == 'Yes') {
      ...
      res.redirect("/prototype-dev-baseline/sprint23/opt1/contact-history-callSummeryAddedd")
    }
})

// add another benefit
router.post('/prototype-dev-baseline/sprint23/opt1/call-log-journey/addAnotherBenefit', function(req, res) {
  req.session.data['whichBenefitDiscussed'] = '';
  req.session.data['questionAsk'] = '';
  req.session.data['npd_wasQuestionResolved'] = '';
  req.session.data['npa_wasQuestionResolved'] = '';
  ...
  res.redirect("/prototype-dev-baseline/sprint23/opt1/call-log-journey/addAnotherBenefit")
})

// Unhappy scenario condition - add another reason?
router.post('/prototype-dev-baseline/sprint23/opt1/goToHome', function(req, res) {
...
router.get('/prototype-dev-baseline/sprint23/opt1/call-log-journey/add-Note/:name', function (req, res) {
  // console.log(' Add Notes route is called - GET: ',req.params.name);
  res.render('/prototype-dev-baseline/sprint23/opt1/call-log-journey/add-Note', {
    "notesName": req.params.name,
    "notesValue": req.session.data[req.params.name]
  });
  });
